...
describe('CountryFilter App', () => {
  ...
  test('should render the Initial state without crash', () => {
  ...
  test('should have right countries in the rendered HTML after filtering', () => {
  ...
  test('should filter countries without case sensitivity', () => {
  ...
  test('should show all contents on resetting the typed fields', () => {
    const input = getByTestId(TEST_IDS.FILTER_FIELD);
  ...
  test('should should show correct content after a series of searches', () => {
    const input = getByTestId(TEST_IDS.FILTER_FIELD);
    fireEvent.keyUp(input, { target: { value: 'les' } });
    fireEvent.change(input, { target: { value: 'les' } });
    fireEvent.keyUp(input, { target: { value: 'man' } });
